...
(function(exports) {
  ...
  var Glosser = function(options) {
    ...
    this.contextSensitiveGlossFinder = function(fields, pouchname, justCopyDontGuessIGT) {
    ...
    this.guessUtteranceFromMorphemes = function(fields, justCopyDontGuessIGT) {
    ...
    this.guessMorphemesFromUtterance = function(fields, justCopyDontGuessIGT) {
      if (fields.morphemes) {
        return fields;
      }
    ...
    this.guessGlossFromMorphemes = function(fields, justCopyDontGuessIGT) {
      if (fields.gloss) {
        return fields;
      }
      if (!fields.morphemes) {
    ...
    */
      ...
      var node = svg.selectAll("circle.node")
        ...
        .on("click", function(d) {
          ...
          if (window.app && window.app.router) {
            // window.app.router.showEmbeddedSearch(pouchname, "morphemes:"+d.fields.morphemes);
            var url = "corpus/" + pouchname + "/search/" + "morphemes:" + d.fields.morphemes;
    ...
    this.isWithinConfidenceRange = function(morpheme, confidenceRange) {
     ...
     */
    this.visualizePrecedenceRelationsAsForceDirectedGraph = function(lexicon, divElement, dontConnectOnWordBoundaries, confidenceRange) {
      ...
      */
      ...
      .enter()
        ...
        .style("opacity", function(d) {
          // return color(d.fields.morphemes.length);
          return 0.5;
        })
      ...
      var circle = svg.append("g").selectAll("circle")
        ...
        .style("fill", function(d) {
          ...
          return color(d.fields.morphemes.length);
          // return color(d.fields.confidence * 10);
        })
        .style("opacity", function(d) {
          // return color(d.fields.morphemes.length);
          return d.fields.confidence ? d.fields.confidence / 2 : 1;
        })
        .on("mouseover", function(object) {
          var findNode = localDocument.getElementById(object.fields.morphemes);
          if (findNode) {
            findNode = findNode.innerHTML + "<p>" + findNode.getAttribute("title") + "<p>";
          } else {
            findNode = "Morpheme: " + object.fields.morphemes + "<br/> Gloss: " + object.fields.gloss + "<br/> Confidence: " + object.fields.confidence;
          }
          return tooltip
            .style("visibility", "visible")
        ...
        .on("click", function(d) {
          ...
          if (window.app && window.app.router) {
            // window.app.router.showEmbeddedSearch(pouchname, "morphemes:"+d.fields.morphemes);
            var url = "corpus/" + lexicon.pouchname + "/search/" + "morphemes:" + d.fields.morphemes;
            // window.location.replace(url);
            window.app.router.navigate(url, {
              trigger: true
            });
